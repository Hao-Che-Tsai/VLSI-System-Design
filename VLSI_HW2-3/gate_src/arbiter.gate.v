...
// Date      : Fri Apr 28 22:06:25 2023
/////////////////////////////////////////////////////////////


module arbiter ( gnt, tout, clk, rst_n, dly, done, req, reset );
  ...
  AO21X1 U36 ( .IN1(n47), .IN2(n31), .IN3(N16), .Q(n29) );
  MUX21X1 U37 ( .IN1(N16), .IN2(n32), .S(n47), .Q(N17) );
  NOR2X0 U38 ( .IN1(n5), .IN2(n24), .QN(n32) );
  AND2X1 U39 ( .IN1(n31), .IN2(n5), .Q(N16) );
  ...
  MUX21X1 U46 ( .IN1(n17), .IN2(n40), .S(n45), .Q(n34) );
  NOR2X0 U47 ( .IN1(tout), .IN2(n17), .QN(n40) );
  OA22X1 U48 ( .IN1(n20), .IN2(reset), .IN3(n39), .IN4(n41), .Q(n23) );
  INVX0 U49 ( .IN(arbiter_ns[1]), .QN(n33) );
  NAND2X0 U50 ( .IN1(n42), .IN2(n43), .QN(arbiter_ns[1]) );
  NAND3X0 U51 ( .IN1(n22), .IN2(n39), .IN3(done), .QN(n43) );
  NAND4X0 U52 ( .IN1(n5), .IN2(n19), .IN3(n49), .IN4(n44), .QN(n39) );
  AND2X1 U53 ( .IN1(n48), .IN2(n46), .Q(n44) );
  INVX0 U54 ( .IN(n41), .QN(n22) );
  NAND2X0 U55 ( .IN1(n45), .IN2(n17), .QN(n41) );
  INVX0 U56 ( .IN(n36), .QN(n42) );
  AO22X1 U57 ( .IN1(reset), .IN2(tout), .IN3(n3), .IN4(n18), .Q(n36) );
endmodule
